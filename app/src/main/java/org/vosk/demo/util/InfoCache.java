...
public final class InfoCache {
    ...
    private static final boolean DEBUG = false;//MainActivity.DEBUG;
    ...
    public void putInfo(final int serviceId, @NonNull final String url, @NonNull final Info info,
        ...
        final long expirationMillis = TimeUnit.MILLISECONDS.convert(1, TimeUnit.HOURS);
        synchronized (LRU_CACHE) {
